...
import ykk.xc.com.wms.warehouse.adapter.ICInvBackup_Repeat_Fragment1_Adapter
...
//                bundle.putInt("finterId", icStockCheckProcess!!.fid)
            ...
            R.id.btn_mtlSel -> { // 选择物料
                ...
                if(stock != null) bundle.putSerializable("stock", stock) // 盘点的仓库
                if(stockArea != null) bundle.putSerializable("stockArea", stockArea) // 盘点的库区
                if(storageRack != null) bundle.putSerializable("storageRack", storageRack) // 盘点的货架
                if(stockPos != null) bundle.putSerializable("stockPos", stockPos) // 盘点的库位
