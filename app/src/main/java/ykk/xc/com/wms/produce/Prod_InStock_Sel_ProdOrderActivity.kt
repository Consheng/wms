...
import ykk.xc.com.wms.produce.adapter.Prod_InStock_Sel_ProdOrder_Adapter
 ...
 * 选择生产任务单dialog
 */
class Prod_InStock_Sel_ProdOrderActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<ProdOrder>()
    private var mAdapter: Prod_InStock_Sel_ProdOrder_Adapter? = null
    ...
    private class MyHandler(activity: Prod_InStock_Sel_ProdOrderActivity) : Handler() {
        private val mActivity: WeakReference<Prod_InStock_Sel_ProdOrderActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ProdOrder::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Prod_InStock_Sel_ProdOrder_Adapter(context, listDatas)
