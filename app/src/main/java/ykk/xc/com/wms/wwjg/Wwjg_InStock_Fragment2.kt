...
import kotlinx.android.synthetic.main.wwjg_in_stock_fragment1.tv_deptSel
import kotlinx.android.synthetic.main.wwjg_in_stock_fragment2.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Wwjg_InStock_Fragment2 : BaseFragment() {
    ...
    companion object {
        ...
        private val RESULT_PROD_ORDER = 8
    }
    ...
    private class MyHandler(activity: Wwjg_InStock_Fragment2) : Handler() {
        private val mActivity: WeakReference<Wwjg_InStock_Fragment2>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    ...
                    SAVE -> { // 保存成功 进入
                        // 保存了分录，供应商就不能修改
                        m.setEnables(m.parent!!.fragment1.tv_deptSel, R.drawable.back_style_gray2a,false)
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.wwjg_in_stock_fragment2, container, false)
    }
    ...
    @OnClick(R.id.tv_sourceTypeSel, R.id.btn_sourceNoSel, R.id.btn_scan, R.id.btn_mtlSel, R.id.tv_stockSel, R.id.tv_stockPosSel, R.id.tv_price, R.id.tv_num, R.id.tv_batchNo, R.id.tv_unitSel, R.id.tv_remark, R.id.btn_save, R.id.btn_clone)
    fun onViewClicked(view: View) {
        when (view.id) {
            ...
            R.id.btn_sourceNoSel -> { // 选择来源单据
                ...
                bundle.putString("deptName", parent!!.fragment1.icStockBill.deptName)
                bundle.putString("strFdetailId", strFdetailId.toString())
                when(icStockBillEntry.fsourceTranType) {
//                    1007105 -> showForResult(Prod_InStock_Sel_ProdOrderActivity::class.java, RESULT_PROD_ORDER, bundle)
                }
            }
...
//                    icStockBillEntry.fdcSPId = stockPos!!.fspId
            ...
            RESULT_PROD_ORDER -> { // 选择单据   返回
                if (resultCode == Activity.RESULT_OK) {
                    if(icStockBillEntry.fsourceTranType == 1007105) {
...
//                        setICStockEntry_POInStock(list)
    ...
    private fun setICStockEntry_ProdOrder(list : List<ProdOrder>) {
        parent!!.fragment1.icStockBill.fselTranType = 1007105
...
//            entry.fentryId = it.fentryid
            ...
            entry.fsourceInterId = it.prodId
            entry.fsourceEntryId = 1
            entry.fsourceTranType = 1007105
            entry.fsourceBillNo = it.prodNo
            entry.fdetailId = it.prodId
...
//                .add("fStockPlaceID", if(stockPos != null) stockPos!!.fspId.toString() else "" )
    ...
    private fun pop_sourceType(v: View) {
        ...
        val popV = layoutInflater.inflate(R.layout.wwjg_in_stock_sourcetype_popwindow, null)
        ...
        val click = View.OnClickListener { v ->
            when (v.id) {
                ...
                R.id.btn2 -> {// 生产订单
                    tv_sourceTypeSel.text = "委外订单"
                    parent!!.fragment1.icStockBill.fselTranType = 1007105
                    icStockBillEntry.fsourceTranType = 1007105
