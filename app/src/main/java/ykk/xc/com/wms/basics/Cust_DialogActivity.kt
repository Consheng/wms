...
import ykk.xc.com.wms.basics.adapter.Cust_DialogAdapter
...
class Cust_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<Customer>()
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Customer::class.java)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("customer/findListByParam")
