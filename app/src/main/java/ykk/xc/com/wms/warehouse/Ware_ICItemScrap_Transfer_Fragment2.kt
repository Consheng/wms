...
import kotlinx.android.synthetic.main.ware_icitemscrap_transfer_fragment2.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Ware_ICItemScrap_Transfer_Fragment2 : BaseFragment() {
    ...
    private class MyHandler(activity: Ware_ICItemScrap_Transfer_Fragment2) : Handler() {
        private val mActivity: WeakReference<Ware_ICItemScrap_Transfer_Fragment2>
...
//                        m.setEnables(m.parent!!.fragment1.tv_suppSel, R.drawable.back_style_gray2a,false)
                        m.parent!!.fragment1.icitemScrapEntryList = null
...
//                        m.toasts("保存成功✔")
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_icitemscrap_transfer_fragment2, container, false)
    }
    ...
    override fun setUserVisibleHint(isVisibleToUser: Boolean) {
        ...
        if (isVisibleToUser) {
            if(parent!!.fragment1.icitemScrapEntryList != null) {
                // 执行保存功能
                setICStockEntry(parent!!.fragment1.icitemScrapEntryList)
            }
            mHandler.sendEmptyMessageDelayed(SETFOCUS, 200)
        }
    }
...
//        }
    ...
    override fun setListener() {
        ...
        tv_outPositionName.setOnLongClickListener{
            ...
            val stockPosName = if(stockPos2 != null) "/"+stockPos2!!.stockPositionName else ""
        ...
        tv_inPositionName.setOnLongClickListener{
            ...
            val stockPosName = if(stockPos != null) "/"+stockPos!!.stockPositionName else ""
            Comm.showWarnDialog(mContext,stockName+stockAreaName+storageRackName+stockPosName)
            true
        }
...
//                        }
    ...
    private fun setICStockEntry(list : List<ICItemScrapEntry>?) {
        parent!!.fragment1.icStockBill.fselTranType = 0
...
//            entry.fprice = it.fprice
            ...
            entry.fsourceBillNo = it.icitemScrap.fbillNO
            entry.fdetailId = 0
