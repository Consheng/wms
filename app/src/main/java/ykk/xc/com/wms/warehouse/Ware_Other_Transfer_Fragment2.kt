...
class Ware_Other_Transfer_Fragment2 : BaseFragment() {
    ...
    companion object {
        ...
        private val RESULT_OUTPOSITION = 9
...
//        }
    ...
    override fun setListener() {
        ...
        // 选择位置---长按
        btn_outPositionSel!!.setOnLongClickListener {
            if(checkSaveHint()) {
                val bundle = Bundle()
                bundle.putInt("mtlId", icStockBillEntry.fitemId)
                bundle.putString("mtlName", getValues(tv_mtlName))
                showForResult(InventoryNowByMtl_DialogActivity::class.java, RESULT_OUTPOSITION, bundle)
            ...
            RESULT_OUTPOSITION -> { // 调出位置	返回
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (bundle != null) {
                        ...
                        resetStockGroup2()
                        stock2 = obj.stock
                        stockArea2 = obj.stockArea
                        storageRack2 = obj.storageRack
                        stockPos2 = obj.stockPosition
                        getStockGroup2(null)
                    }
                }
            }
