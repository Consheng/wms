...
import ykk.xc.com.wms.basics.adapter.Mtl_BomDialogAdapter
import ykk.xc.com.wms.basics.adapter.Mtl_DialogAdapter
 ...
 * 选择Bom物料列表
 */
class Mtl_BomDialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<ICBom>()
    private var mAdapter: Mtl_BomDialogAdapter? = null
    ...
    private class MyHandler(activity: Mtl_BomDialogActivity) : Handler() {
        private val mActivity: WeakReference<Mtl_BomDialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, ICBom::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Mtl_BomDialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("bom/findListByPage")
