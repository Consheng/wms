...
import kotlinx.android.synthetic.main.sal_qcpass_fragment1.*
import kotlinx.android.synthetic.main.sal_qcpass_main.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Sal_QcPass_Fragment1 : BaseFragment() {
    ...
    private var parent: Sal_QcPass_MainActivity? = null
...
//    var isReset = false // 是否点击了重置按钮.
    ...
    private class MyHandler(activity: Sal_QcPass_Fragment1) : Handler() {
        private val mActivity: WeakReference<Sal_QcPass_Fragment1>
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.sal_qcpass_fragment1, container, false)
    }

    override fun initView() {
        mContext = getActivity()
        parent = mContext as Sal_QcPass_MainActivity
    }
    ...
    override fun initData() {
        ...
        icStockBill.billType = "CKZJ" // 出库质检
