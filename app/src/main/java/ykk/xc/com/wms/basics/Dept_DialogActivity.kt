...
import ykk.xc.com.wms.basics.adapter.Dept_DialogAdapter
...
class Dept_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<Department>()
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Department::class.java)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("department/findListByParam")
