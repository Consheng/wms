...
//        tv_boxSize.text = Html.fromHtml("规格:&nbsp;<font color='#000000'>"+entity.box.boxSize+"</font>")
        ...
        if(entity.strSourceNo != null) {
            tv_strSourceNo.text = Html.fromHtml("源单:&nbsp;<font color='#000000'>" +entity.strSourceNo+ "</font>")
