...
import kotlinx.android.synthetic.main.sal_sel_seorder.*
import okhttp3.*
import ykk.xc.com.wms.R
import ykk.xc.com.wms.bean.k3Bean.SeOrderEntry
import ykk.xc.com.wms.bean.pur.POInStockEntry
import ykk.xc.com.wms.comm.BaseDialogActivity
import ykk.xc.com.wms.comm.Comm
import ykk.xc.com.wms.sales.adapter.Sal_OutStock_SelSeOrderAdapter
 ...
 * 选择销售订单dialog
 */
class Sal_OutStock_SelSeOrderActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<SeOrderEntry>()
    private var mAdapter: Sal_OutStock_SelSeOrderAdapter? = null
    ...
    private class MyHandler(activity: Sal_OutStock_SelSeOrderActivity) : Handler() {
        private val mActivity: WeakReference<Sal_OutStock_SelSeOrderActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 -> {// 成功
                        val list = JsonUtil.strToList2(msg.obj as String, SeOrderEntry::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.sal_sel_seorder
    }
    ...
    override fun initView() {
        ...
        mAdapter = Sal_OutStock_SelSeOrderAdapter(context, listDatas)
    ...
    fun onViewClicked(view: View) {
        when (view.id) {
            ...
            R.id.btn_confirm -> { // 确定
                ...
                val list = ArrayList<SeOrderEntry>()
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("seOrder/findList")
