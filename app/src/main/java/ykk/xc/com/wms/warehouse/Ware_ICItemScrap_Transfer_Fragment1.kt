...
import kotlinx.android.synthetic.main.ware_icitemscrap_transfer_fragment1.*
import kotlinx.android.synthetic.main.ware_icitemscrap_transfer_main.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Ware_ICItemScrap_Transfer_Fragment1 : BaseFragment() {
    ...
    private var parent: Ware_ICItemScrap_Transfer_MainActivity? = null
    private val df = DecimalFormat("#.###")
    private var timesTamp:String? = null // 时间戳
    var icStockBill = ICStockBill() // 保存的对象
    var icitemScrapEntryList:List<ICItemScrapEntry>? = null
    private var icStockBillId = 0 // 上个页面传来的id

    // 消息处理
    private val mHandler = MyHandler(this)

    private class MyHandler(activity: Ware_ICItemScrap_Transfer_Fragment1) : Handler() {
        private val mActivity: WeakReference<Ware_ICItemScrap_Transfer_Fragment1>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    ...
                    FIND_SOURCE ->{ // 查询源单 返回
                        val list = JsonUtil.strToList(msgObj, ICItemScrapEntry::class.java)
                        m.icitemScrapEntryList = list
                        m.icStockBill.fdeptId = list[0].fworkShop
                        m.icStockBill.deptName = list[0].dept.departmentName
                        m.tv_deptSel.text = list[0].dept.departmentName
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_icitemscrap_transfer_fragment1, container, false)
    }

    override fun initView() {
        mContext = getActivity()
        parent = mContext as Ware_ICItemScrap_Transfer_MainActivity
    }
    ...
    override fun initData() {
        ...
        icStockBill.billType = "BLDBD" // 补料调拨单
    ...
    fun bundle() {
        ...
        if(bundle != null) {
            ...
            if(bundle.containsKey("missionBill")) {
                ...
                run_findICItemScrapEntryList(missionBill.sourceBillId)
...
//        icstockBill.weightUnitType = 1
     ...
     * 查询源单（补料单）
     */
    private fun run_findICItemScrapEntryList(finterID: Int) {
        showLoadDialog("保存中...", false)
        val mUrl = getURL("icitemScrap/findEntryByParam")
