...
import kotlinx.android.synthetic.main.ware_inventorynow_by_mtl_dialog.*
import okhttp3.*
...
import ykk.xc.com.wms.warehouse.adapter.InventoryNowByMtl_DialogAdapter
 ...
 * 选择盘点方案dialog
 */
class InventoryNowByMtl_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    internal var btnSearch: Button? = null
    private val context = this
    private val listDatas = ArrayList<InventoryNow>()
    private var mAdapter: InventoryNowByMtl_DialogAdapter? = null
    ...
    private class MyHandler(activity: InventoryNowByMtl_DialogActivity) : Handler() {
        private val mActivity: WeakReference<InventoryNowByMtl_DialogActivity>
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ware_inventorynow_by_mtl_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = InventoryNowByMtl_DialogAdapter(context, listDatas)
